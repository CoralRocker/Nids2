...
impl<T> Saveable<Self> for Option<T> where T: Saveable<T> {
    fn to_bytes(&self) -> Vec<u8> {
...
impl<T> Saveable<Self> for Rc<T>  where T: Saveable<T> {
    fn to_bytes(&self) -> Vec<u8> {
...
impl<T> Saveable<Self> for RefCell<T> where T: Saveable<T> {
    fn to_bytes(&self) -> Vec<u8> {
